...
class TestAll(unittest.TestCase):
    def test_min_unsorted(self):
        ...
        result = aug8_2021.find_unsorted_subarray(nums)
        answer = 5
    ...
    def test_mono_increasing_short(self):
        nums = [1]
        result = aug8_2021.find_mono_increasing(nums)
        answer = 0
        self.assertEqual(answer, result)
    ...
    def test_find_front_max(self):
        nums = [1, 2, 3, 4, 5, 0]
        result = aug8_2021.find_front_max(nums)
        answer = -1
        self.assertEqual(answer, result)
    ...
    def test_find_back_min_case1(self):
        nums = [1, 7, 3, 5, 6, 4]
        result = aug8_2021.find_back_min(nums)
        answer = 6
        self.assertEqual(answer, result)
